package com.example.gataulahh1;
...
public class TampilData extends AppCompatActivity {
    ...
    public static final String URLTAMPIL = "http://192.168.208.179/androiddb/siswa/select.php";
    public static final String URLDELETE = "http://192.168.208.179/androiddb/siswa/delete.php";
    public static final String URLINSERT = "http://192.168.208.179/androiddb/siswa/insert.php";
    public static final String URLUBAH = "http://192.168.208.179/androiddb/siswa/edit.php";
    ...
    private void DialogForm(String idx, String nikx, String namex, String alamatx, String kotax, String jkx, String umurx,  String button) {
        ...
        dialogView = inflater.inflate(R.layout.form_pegawai, null);
